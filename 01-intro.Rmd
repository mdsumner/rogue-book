...
Note that `sp` is a bit inconsistent since it doesn't have Point and Points objects as analoges to Line/Polygon and Lines/Polygon - but the entire topic is rife with these confusing problems so let's move on. 


## What do we do in R?

In many ways it is easier to talk about the details in terms of the actual coordinates.
