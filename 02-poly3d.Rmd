...
```{r plot3d_wrld, webgl = TRUE, rgl.newwindow = TRUE, eval = FALSE}
library(rgl)
library(rglwidget)  ## allows embedding OpenGL vis in RMarkdown HTML
...
```{r plot3d_wrldxyz, webgl = TRUE, rgl.newwindow = TRUE, eval=FALSE}
...
```{r plot3d_wrldoznz, webgl = TRUE, rgl.newwindow = TRUE,  eval=FALSE}
...
```{r plot3d_wrld_polyxyz, webgl = TRUE, rgl.newwindow = TRUE,eval=FALSE}
...
```{r plot3d_wrld_surfacexyz, webgl = TRUE, rgl.newwindow = TRUE, eval=FALSE}
...
```{r plot3d_wrld_surfaceobjects, webgl = TRUE, rgl.newwindow = TRUE, eval=FALSE}
## loop over objects
...
Include a button for the animation
...

## Github, sfr

There is ongoing work to upgrade R's Spatial support, but this is still wedded to the basic flat and dumb polygonal model used by OGC. 
...
```{r plot3d_texture, webgl = TRUE, rgl.newwindow = TRUE, eval= FALSE}
